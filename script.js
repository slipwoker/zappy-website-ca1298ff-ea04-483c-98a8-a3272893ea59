  ...
  function initScrollAnimations() {
    ...
    if ('IntersectionObserver' in window) {
      ...
      elements.forEach(function (el, index) {
        ...
        } else if (el.dataset.stagger !== undefined) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "About That משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ca1298ff-ea04-483c-98a8-a3272893ea59',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ca1298ff-ea04-483c-98a8-a3272893ea59';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ca1298ff-ea04-483c-98a8-a3272893ea59';
